		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 col-lg-9">
					...
					<p vocab="http://schema.org/" typeof="person">Hello! My name is <span property="name">Korigan Payne</span>. I am an Albuquerque-based freelance web developer and I create attractive and functional websites for businesses and entrepreneurs. If I am not freelancing at some of Albuquerque's finest digital agencies, I am working remotely on projects for clients all over the world. I have a diverse set of skills, ranging from design, to HTML5 + CSS3 + Javascript, all the way to PHP.</p>
